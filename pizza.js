...
let requestURL = 'https://kuanwen-liu.github.io/JSON-Georgian/pizza.json';
...
function pizzaTypes(jsonObj) {
  ...
  for(let i = 0; i < pizzaTypes.length; i++) {
    ...
    img.setAttribute('src', 'https://kuanwen-liu.github.io/JSON-Georgian/assets/' + pizzaTypes[i].image);
